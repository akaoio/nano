#include "call_rknn_set_weight_mem.h"
#include <rknn_api.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
json_object* call_rknn_set_weight_mem(json_object* params) {
    ...
    // Call RKNN function
    int ret = rknn_set_weight_mem(context, mem);
    ...
    if (ret != RKNN_SUCC) {
        json_object_object_add(result, "error", json_object_new_string("rknn_set_weight_mem failed"));
    }
